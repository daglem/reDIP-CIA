...
module pia_edgedet (
    ...
    // The simple DFF + combinational ciruit below captures the gist of the PIA
    ...
    //    corresponding IRQ bit in the CA / CB register.
    // 3. As long as the corresponding IRQ bit is set, the current input level
