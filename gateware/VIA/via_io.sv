...
module via_io (
    ...
    inout  via::reg4_t  pad_addr,
    inout  via::reg8_t  pad_data,
    inout  via::reg8_t  pad_pa,
    inout  via::reg8_t  pad_pb,
    inout  logic        pad_ca1,
    inout  logic        pad_ca2,
    inout  logic        pad_cb1,
    inout  logic        pad_cb2,
    inout  logic        pad_irq_n,
    // VIA internal bus I/O.
    output via::bus_i_t bus_i,
    input  via::bus_o_t bus_o
);
    ...
    always_comb begin
        ...
        // NB! The MOS 6522 latches CS1, CS2, R_W, and RS0-RS3 before the rising
        // edge of phi2.
        phi1_io     = ~phi2_io;
    ...
    always_ff @(posedge clk) begin
        ...
        ddrd   <= bus_i.cs1 & ~bus_i.cs2_n & bus_i.r_w_n & phi2_io & phi2;
...
`endif
        .INPUT_CLK     (clk),
        .OUTPUT_CLK    (clk),
        .OUTPUT_ENABLE (bus_o.ports.ddrcb1),
        .D_IN_0        (cb1_x),
        .D_OUT_0       (bus_o.ports.cb1)
    );
